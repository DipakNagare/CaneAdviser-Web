...
public interface CaneAdviserService {
    ...
    void saveQueryAssignedMaster(QueryAssignedMaster assignedMaster);

    Optional<Queryhandler> getQueryhandlerById(int questionId);

    void updateQueryAnswer(int queId, String answer);
