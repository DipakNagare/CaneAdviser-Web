(function() {
    ...
    function r() {
        function c() {
            var b = a,
                ...
                d = b.length,
                e;
            while (++c < d)(e = b[c].on) && e.apply(this, arguments)
        }
        var a = [],
            b = {};
        return c.on = function(d, e) {
            var f, g;
            if (arguments.length < 2) return (f = b[d]) && f.on;
            if (f = b[d]) f.on = null, a = a.slice(0, g = a.indexOf(f)).concat(a.slice(g + 1)), delete b[d];
            return e && a.push(b[d] = {
                on: e
            }), c
        }, c
    ...
    function bI(a) {
        var b = [a.a, a.b],
            ...
            e = bJ(b, c),
            f = bK(bL(c, b, -e)) || 0;
        b[0] * c[1] < c[0] * b[1] && (b[0] *= -1, b[1] *= -1, d *= -1, e *= -1), this.rotate = (d ? Math.atan2(b[1], b[0]) : Math.atan2(-c[0], c[1])) * bO, this.translate = [a.e, a.f], this.scale = [d, f], this.skew = f ? Math.atan2(e, f) * bO : 0
    }
    ...
    function bR(a) {
        return a.rangeExtent ? a.rangeExtent() : bQ(a.range())
    }
    ...
    function bY(a, b) {
        return d3.range.apply(d3, bX(a, b))
    }

    function bZ(a, b) {
        return d3.format(",." + Math.max(0, -Math.floor(Math.log(bX(a, b)[2]) / Math.LN10 + .01)) + "f")
    }
    ...
    function ca(a, b) {
        ...
        return d.invert = function(b) {
            ...
            return arguments.length ? (b = e[0] < 0 ? cd : cc, c = b.pow, a.domain(e.map(b)), d) : a.domain().map(c)
        }, d.nice = function() {
            return a.domain(bS(a.domain(), bT)), d
        }, d.ticks = function() {
            var d = bQ(a.domain()),
                e = [];
            if (d.every(isFinite)) {
            ...
            arguments.length < 2 && (e = cb);
            if (arguments.length < 1) return e;
            var f = a / d.ticks().length,
                g = b === cd ? (h = -1e-12, Math.floor) : (h = 1e-12, Math.ceil),
                h;
            return function(a) {
    ...
    function ce(a, b) {
        ...
        return e.invert = function(b) {
            ...
            return bZ(e.domain(), a)
        }, e.nice = function() {
            return e.domain(bS(e.domain(), bW))
        }, e.exponent = function(a) {
            if (!arguments.length) return b;
            var f = e.domain();
            return c = cf(b = a), d = cf(1 / b), e.domain(f)
        }, e.copy = function() {
            return ce(a.copy(), b)
        }, bV(e, a)
    }
    ...
    function ct(a) {
        function g(d) {
            return d.length < 1 ? null : "M" + e(a(cu(this, d, b, c)), f)
        }
        var b = cv,
            c = cw,
            d = "linear",
        ...
        return g.x = function(a) {
            ...
            return arguments.length ? (e = cx[d = a], g) : d
    ...
    function cB(a, b) {
        return a.length < 4 ? cy(a) : a[1] + cE(a.slice(1, a.length - 1), cF(a, b))
    }

    function cC(a, b) {
        return a.length < 3 ? cy(a) : a[0] + cE((a.push(a[0]), a), cF([a[a.length - 2]].concat(a, [a[1]]), b))
    }

    function cD(a, b, c) {
        return a.length < 3 ? cy(a) : a[0] + cE(a, cF(a, b))
    }

    function cE(a, b) {
        if (b.length < 1 || a.length != b.length && a.length != b.length + 2) return cy(a);
    ...
    function cG(a) {
        ...
        var b = 1,
            ...
            i = [e, ",", f];
        cO(i, g, h);
        while (++b < c) d = a[b], g.shift(), g.push(d[0]), h.shift(), h.push(d[1]), cO(i, g, h);
        b = -1;
        while (++b < 2) g.shift(), g.push(d[0]), h.shift(), h.push(d[1]), cO(i, g, h);
        return i.join("")
    }

    function cH(a) {
        if (a.length < 4) return cy(a);
        var b = [],
            c = -1,
            d = a.length,
            e, f = [0],
        ...
        b.push(cK(cN, f) + "," + cK(cN, g)), --c;
        while (++c < d) e = a[c], f.shift(), f.push(e[0]), g.shift(), g.push(e[1]), cO(b, f, g);
        return b.join("")
    }
    ...
    function cI(a) {
        ...
        b = [cK(cN, g), ",", cK(cN, h)], --c;
        while (++c < e) f = a[c % d], g.shift(), g.push(f[0]), h.shift(), h.push(f[1]), cO(b, g, h);
        return b.join("")
    }
    ...
    function cO(a, b, c) {
        a.push("C", cK(cL, b), ",", cK(cL, c), ",", cK(cM, b), ",", cK(cM, c), ",", cK(cN, b), ",", cK(cN, c))
    }
    ...
    function cQ(a) {
        var b = 0,
            ...
            f = a[1],
            g = d[0] = cP(e, f);
        while (++b < c) d[b] = g + (g = cP(e = f, f = a[b + 1]));
        return d[b] = g, d
    }
    ...
    function cR(a) {
        var b = [],
            ...
            h = -1,
            i = a.length - 1;
        while (++h < i) c = cP(a[h], a[h + 1]), Math.abs(c) < 1e-6 ? g[h] = g[h + 1] = 0 : (d = g[h] / c, e = g[h + 1] / c, f = d * d + e * e, f > 9 && (f = c * 3 / Math.sqrt(f), g[h] = f * d, g[h + 1] = f * e));
        h = -1;
    ...
    function cS(a) {
        return a.length < 3 ? cy(a) : a[0] + cE(a, cR(a))
    }
    ...
    function cT(a) {
        var b, c = -1,
            d = a.length,
            e, f;
        while (++c < d) b = a[c], e = b[0], f = b[1] + cn, b[0] = e * Math.cos(f), b[1] = e * Math.sin(f);
        return a
    }
    ...
    function cU(a) {
        function j(f) {
            ...
            var j = cu(this, f, b, d),
                k = cu(this, f, b === c ? cV(j) : c, d === e ? cW(j) : e);
        ...
        return j.x = function(a) {
            ...
            return arguments.length ? (g = cx[f = a], h = g.reverse || g, j) : f
    ...
    function dd(a, b) {
        ...
        if (dc < 0 && (window.scrollX || window.scrollY)) {
            var d = d3.select(document.body).append("svg").style("position", "absolute").style("top", 0).style("left", 0),
                e = d[0][0].getScreenCTM();
            dc = !e.f && !e.e, d.remove()
        }
        return dc ? (c.x = b.pageX, c.y = b.pageY) : (c.x = b.clientX, c.y = b.clientY), c = c.matrixTransform(a.getScreenCTM().inverse()), [c.x, c.y]
    }
    ...
    function dz() {
        d3.event.keyCode == 32 && dp && !dt && (dv = null, dw[0] -= ds[1][0], dw[1] -= ds[1][1], dt = 2, O())
    }

    function dA() {
        d3.event.keyCode == 32 && dt == 2 && (dw[0] += ds[1][0], dw[1] += ds[1][1], dt = 0, O())
    }

    function dB() {
        if (dw) {
            var a = d3.svg.mouse(dp),
                b = d3.select(dp);
            dt || (d3.event.altKey ? (dv || (dv = [(ds[0][0] + ds[1][0]) / 2, (ds[0][1] + ds[1][1]) / 2]), dw[0] = ds[+(a[0] < dv[0])][0], dw[1] = ds[+(a[1] < dv[1])][1]) : dv = null), dq && (dC(a, dq, 0), dx(b, ds)), dr && (dC(a, dr, 1), dy(b, ds)), dn("brush")
        }
    }
    ...
    function dC(a, b, c) {
        var d = bR(b),
            ...
            h = ds[1][c] - ds[0][c],
            i, j;
        dt && (e -= g, f -= h + g), i = Math.max(e, Math.min(f, a[c])), dt ? j = (i += g) + h : (dv && (g = Math.max(e, Math.min(f, 2 * dv[c] - i))), g < i ? (j = i, i = g) : j = g), ds[0][c] = i, ds[1][c] = j
    }

    function dD() {
        dw && (dB(), d3.select(dp).selectAll(".resize").style("pointer-events", dm.empty() ? "none" : "all"), dn("brushend"), dm = dn = dp = dq = dr = ds = dt = du = dv = dw = null, O())
    }
    ...
    function dM(a) {
        ...
        b && (d.x = b[0] + dJ[0], d.y = b[1] + dJ[1], d.dx = b[0] - dK[0], d.dy = b[1] - dK[1], dL |= d.dx | d.dy, dK = b);
        try {
            dF[a].apply(dH, dI)
        } finally {
            d3.event = c
    ...
    function dP() {
        if (!dH) return;
        dM("dragend"), dL && (O(), dL = d3.event.target === dG), dF = dG = dH = dI = dJ = dK = null
    }
    ...
    function eb(a) {
        return [a[0] - dW[0], a[1] - dW[1], dW[2]]
    }

    function ec() {
        dR || (dR = d3.select("body").append("div").style("visibility", "hidden").style("top", 0).style("height", 0).style("width", 0).style("overflow-y", "scroll").append("div").style("height", "2000px").node().parentNode);
        var a = d3.event,
            b;
        try {
            dR.scrollTop = 1e3, dR.dispatchEvent(a), b = 1e3 - dR.scrollTop
        } catch (c) {
    ...
    function ed() {
        var a = d3.svg.touches(d$),
            b = -1,
            c = a.length,
            d;
        while (++b < c) dU[(d = a[b]).identifier] = eb(d);
        return a
    }
    ...
    function ee() {
        ...
        switch (a.length) {
            ...
            case 2:
                ...
                ei(Math.log(d3.event.scale) / Math.LN2 + f[2], e, h)
        }
    }

    function ef() {
        dT = null, dS && (ea = 1, ei(dW[2], d3.svg.mouse(d$), dS))
    }

    function eg() {
        dS && (ea && (O(), ea = dZ === d3.event.target), dW = dX = dY = dZ = d$ = d_ = dS = null)
    }
    ...
    function ei(a, b, c) {
        ...
        a = ek(a, 2);
        var d = Math.pow(2, dW[2]),
            e = Math.pow(2, a),
            f = Math.pow(2, (dW[2] = a) - c[2]),
            g = dW[0],
            h = dW[1],
            i = dW[0] = ek(b[0] - c[0] * f, 0, e),
            j = dW[1] = ek(b[1] - c[1] * f, 1, e),
            k = d3.event;
        d3.event = {
            scale: e,
            translate: [i, j],
    ...
    d3.ns = {
        ...
        var a = new q,
            b = -1,
            c = arguments.length;
        while (++b < c) a[arguments[b]] = r();
        return a
    }, q.prototype.on = function(a, b) {
        var c = a.indexOf("."),
            d = "";
        return c > 0 && (d = a.substring(c + 1), a = a.substring(0, c)), arguments.length < 2 ? this[a].on(d) : (this[a].on(d, b), this)
    ...
    var s = /(?:([^{])?([<>=^]))?([+\- ])?(#)?(0)?([0-9]+)?(,)?(\.[0-9]+)?([a-zA-Z%])?/,
        ...
        x = ["y", "z", "a", "f", "p", "n", "μ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(y);
    ...
    bi.style = function(a, b, c) {
        ...
        for (var a = -1, b = this.length; ++a < b;)
            for (var c = this[a], d = c.length - 1, e = c[d], f; --d >= 0;)
                if (f = c[d]) e && e.parentNode.insertBefore(f, e), e = f;
        return this
    }, bi.sort = function(a) {
    ...
    d3.transform = function(a) {
        bM.setAttribute("transform", a);
        var b = bM.transform.baseVal.consolidate();
        return new bI(b ? b.matrix : bN)
    }, bI.prototype.toString = function() {
        return "translate(" + this.translate + ")rotate(" + this.rotate + ")skewX(" + this.skew + ")scale(" + this.scale + ")"
    };
    var bM = document.createElementNS(d3.ns.prefix.svg, "g"),
        bN = {
            a: 1,
            b: 0,
            c: 0,
    ...
    d3.scale = {}, d3.scale.linear = function() {
        return bU([0, 1], [0, 1], d3.interpolate, !1)
    }, d3.scale.log = function() {
        return ca(d3.scale.linear(), cc)
    };
    var cb = d3.format(".0e");
    cc.pow = function(a) {
        ...
        return d3.scale.ordinal().range(cj)
    }, d3.scale.category20c = function() {
        return d3.scale.ordinal().range(ck)
    };
    var ch = ["#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf"],
        ci = ["#1f77b4", "#aec7e8", "#ff7f0e", "#ffbb78", "#2ca02c", "#98df8a", "#d62728", "#ff9896", "#9467bd", "#c5b0d5", "#8c564b", "#c49c94", "#e377c2", "#f7b6d2", "#7f7f7f", "#c7c7c7", "#bcbd22", "#dbdb8d", "#17becf", "#9edae5"],
        cj = ["#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6"],
        ck = ["#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9"];
    d3.scale.quantile = function() {
        ...
        function e() {
            var e = a.apply(this, arguments),
                ...
                g = c.apply(this, arguments) + cn,
                h = d.apply(this, arguments) + cn,
                ...
                m = Math.cos(h),
                n = Math.sin(h);
            return i >= co ? e ? "M0," + f + "A" + f + "," + f + " 0 1,1 0," + -f + "A" + f + "," + f + " 0 1,1 0," + f + "M0," + e + "A" + e + "," + e + " 0 1,0 0," + -e + "A" + e + "," + e + " 0 1,0 0," + e + "Z" : "M0," + f + "A" + f + "," + f + " 0 1,1 0," + -f + "A" + f + "," + f + " 0 1,1 0," + f + "Z" : e ? "M" + f * k + "," + f * l + "A" + f + "," + f + " 0 " + j + ",1 " + f * m + "," + f * n + "L" + e * m + "," + e * n + "A" + e + "," + e + " 0 " + j + ",0 " + e * k + "," + e * l + "Z" : "M" + f * k + "," + f * l + "A" + f + "," + f + " 0 " + j + ",1 " + f * m + "," + f * n + "L0,0" + "Z"
        }
        var a = cp,
            b = cq,
            c = cr,
        ...
        return e.innerRadius = function(b) {
            ...
            var e = (a.apply(this, arguments) + b.apply(this, arguments)) / 2,
                f = (c.apply(this, arguments) + d.apply(this, arguments)) / 2 + cn;
    ...
    d3.svg.line.radial = function() {
    ...
    }, cz.reverse = cA, cA.reverse = cz, d3.svg.area = function() {
        return cU(Object)
        ...
        return a.projection = function(a) {
            return arguments.length ? c(db(b = a)) : b
        }, a
    }, d3.svg.mouse = function(a) {
        return dd(a, d3.event)
    };
    var dc = /WebKit/.test(navigator.userAgent) ? -1 : 0;
    d3.svg.touches = function(a, b) {
        ...
        function c(c, d) {
            return (dg[a.call(this, c, d)] || dg.circle)(b.call(this, c, d))
        }
        var a = df,
            b = de;
    ...
    d3.svg.symbolTypes = d3.keys(dg);
    var dh = Math.sqrt(3),
        di = Math.tan(30 * Math.PI / 180);
    d3.svg.axis = function() {
        function j(j) {
            j.each(function(k, l, m) {
                ...
                switch (b) {
                    case "bottom":
                        A = dj, v.attr("x2", 0).attr("y2", d), z.select("line").attr("x2", 0).attr("y2", c), z.select("text").attr("x", 0).attr("y", Math.max(c, 0) + f).attr("dy", ".71em").attr("text-anchor", "middle"), E.attr("d", "M" + B[0] + "," + e + "V0H" + B[1] + "V" + e);
                        break;
                    case "top":
                        A = dj, v.attr("x2", 0).attr("y2", -d), z.select("line").attr("x2", 0).attr("y2", -c), z.select("text").attr("x", 0).attr("y", -(Math.max(c, 0) + f)).attr("dy", "0em").attr("text-anchor", "middle"), E.attr("d", "M" + B[0] + "," + -e + "V0H" + B[1] + "V" + -e);
                        break;
                    case "left":
                        A = dk, v.attr("x2", -d).attr("y2", 0), z.select("line").attr("x2", -c).attr("y2", 0), z.select("text").attr("x", -(Math.max(c, 0) + f)).attr("y", 0).attr("dy", ".32em").attr("text-anchor", "end"), E.attr("d", "M" + -e + "," + B[0] + "H0V" + B[1] + "H" + -e);
                        break;
                    case "right":
                        A = dk, v.attr("x2", d).attr("y2", 0), z.select("line").attr("x2", c).attr("y2", 0), z.select("text").attr("x", Math.max(c, 0) + f).attr("y", 0).attr("dy", ".32em").attr("text-anchor", "start"), E.attr("d", "M" + e + "," + B[0] + "H0V" + B[1] + "H" + e)
                }
        ...
        function e(a) {
            ...
            a.each(function() {
                ...
                h.enter().append("rect").attr("class", "background").style("visibility", "hidden").style("pointer-events", "all").style("cursor", "crosshair"), i.enter().append("rect").attr("class", "extent").style("cursor", "move"), j.enter().append("rect").attr("class", function(a) {
                    ...
                    return dE[a]
                }), j.exit().remove(), b && (k = bR(b), h.attr("x", k[0]).attr("width", k[1] - k[0]), dx(a, d)), c && (k = bR(c), h.attr("y", k[0]).attr("height", k[1] - k[0]), dy(a, d))
            })
        }

        function f() {
            var a = d3.select(d3.event.target);
            dm = e, dp = this, ds = d, dw = d3.svg.mouse(dp), (dt = a.classed("extent")) ? (dw[0] = d[0][0] - dw[0], dw[1] = d[0][1] - dw[1]) : a.classed("resize") ? (du = d3.event.target.__data__, dw[0] = d[+/w$/.test(du)][0], dw[1] = d[+/^n/.test(du)][1]) : d3.event.altKey && (dv = dw.slice()), dq = !/^(n|s)$/.test(du) && b, dr = !/^(e|w)$/.test(du) && c, dn = g(this, arguments), dn("brushstart"), dB(), O()
        }
        ...
        }, d3.select(window).on("mousemove.brush", dB).on("mouseup.brush", dD).on("keydown.brush", dz).on("keyup.brush", dA), d3.rebind(e, a, "on")
    };
    var dm, dn, dp, dq, dr, ds, dt, du, dv, dw, dE = {
        n: "ns-resize",
        e: "ew-resize",
        s: "ns-resize",
        w: "ew-resize",
    ...
    d3.behavior = {}, d3.behavior.drag = function() {
        function c() {
            this.on("mousedown.drag", e).on("touchstart.drag", e), d3.select(window).on("mousemove.drag", dO).on("touchmove.drag", dO).on("mouseup.drag", dP, !0).on("touchend.drag", dP, !0).on("click.drag", dQ, !0)
        }

        function d() {
            dF = a, dG = d3.event.target, dH = this, dI = arguments, dK = dN(), b ? (dJ = b.apply(dH, dI), dJ = [dJ.x - dK[0], dJ.y - dK[1]]) : dJ = [0, 0], dL = 0
        }

        function e() {
            d.apply(this, arguments), dM("dragstart")
        }
    ...
    var dF, dG, dH, dI, dJ, dK, dL;
    d3.behavior.zoom = function() {
        function d() {
            this.on("mousedown.zoom", f).on("mousewheel.zoom", g).on("DOMMouseScroll.zoom", g).on("dblclick.zoom", h).on("touchstart.zoom", i), d3.select(window).on("mousemove.zoom", ef).on("mouseup.zoom", eg).on("touchmove.zoom", ee).on("touchend.zoom", ed).on("click.zoom", eh, !0)
        }

        function e() {
            dW = a, dX = c, dY = b.zoom, dZ = d3.event.target, d$ = this, d_ = arguments
        }

        function f() {
            e.apply(this, arguments), dS = eb(d3.svg.mouse(d$)), ea = 0, d3.event.preventDefault(), window.focus()
        }

        function g() {
            e.apply(this, arguments), dT || (dT = eb(d3.svg.mouse(d$))), ei(ec() + a[2], d3.svg.mouse(d$), dT)
        }

        function h() {
            e.apply(this, arguments);
            var b = d3.svg.mouse(d$);
            ei(d3.event.shiftKey ? Math.ceil(a[2] - 1) : Math.floor(a[2] + 1), b, eb(b))
        }
        ...
        function i() {
            ...
            var b = ed(),
                c, d = Date.now();
            b.length === 1 && d - dV < 300 && ei(1 + Math.floor(a[2]), c = b[0], dU[c.identifier]), dV = d
        }
        var a = [0, 0, 0],
            b = d3.dispatch("zoom"),
            c = ej;
        return d.extent = function(a) {
            return arguments.length ? (c = a == null ? ej : a, d) : c
        }, d3.rebind(d, b, "on")
    };
    var dR, dS, dT, dU = {},
        dV = 0,
        dW, dX, dY, dZ, d$, d_, ea, ej = [
            [-Infinity, Infinity],
            [-Infinity, Infinity],
            [-Infinity, Infinity]
        ]
